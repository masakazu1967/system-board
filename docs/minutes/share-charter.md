...
**Q1-1回答**: 毎週の運用保守連絡会で確認します。緊急時の脆弱性発見時にはGitHub Flowのhotfix対応を行います。ライブラリのパッチが出ている場合は、パッチを当てた後単体テストを実行します。
...
**Q3-1回答**: DDDによる境界設計（イベントストーミング活用）
